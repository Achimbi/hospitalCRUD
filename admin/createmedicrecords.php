  ...
  <div class="main-content" id="panel">
    ...
    <?php
        ...
        if(isset($_POST['submit'])) {
            ...
            $query = " INSERT INTO `medikhistory`(`medical_issue`, `staff_info`, `patient_name`, `patient_sex`, `patient_address`, `date`, `treatment_status`, `total_cost` ) 
            VALUES('{$medical_issue}', '{$staff_info}', '{$patient_name}', '{$patient_sex}', '{$patient_address}', '{$date}', '{$treatment_status}', '{$total_cost}') ";
        ...
        if(!$createstaff_query){
          ...
          echo "<h3>Medical History Record created successfully!!!!</h3>";
        }
    ...
    <div class="col-xl-8 order-xl-1">
          <div class="card">
            <div class="card-header">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">Create Medical Record </h3>
                </div>
