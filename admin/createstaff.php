  ...
  <div class="main-content" id="panel">
            ...
            <div class="col-xl-3 col-md-6">
              <div class="card card-stats">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Create Account</h5>
                  ...
                  <p class="mt-3 mb-0 text-sm">
                    ...
                    <span class="text-nowrap">Create New Medical Account</span>
                  </p>
                </div>
              </div>
            </div>
    ...
    <?php
        ...
        if(isset($_POST['submit'])) {
            ...
            move_uploaded_file($post_image_temp, "../img/medical/$post_image");

            
            $query = " INSERT INTO `staff`(`first_name`, `last_name`, `sex`, `staff_role`, `img`, `username`, `password`, `email_address`, `address`, `phone_number`) 
            VALUES('{$firstname}', '{$lastname}', '{$sex}', '{$staff_role}', '{$post_image}', '{$username}', '{$password}', '{$email_address}', '{$address}', '{$phone_number}') ";

        $createstaff_query = mysqli_query($connection, $query);

        if(!$createstaff_query){
            die('Query Failed' . mysqli_error($connection));
        } else {
          echo "<h3>Staff account created successfully!!!!</h3>";
        }
