                ...
                <!-- for the loop
                  ...
                  for the loop-->
                    ...
                    <?php
                        ...
                        $query = "SELECT staff_id, first_name, last_name, sex, staff_role, username, email_address FROM `staff` WHERE staff_role <> ' '";
                        ...
                        if(mysqli_num_rows($readstaff_query) > 0){
                            while($result = mysqli_fetch_assoc($readstaff_query)){
                                ...
                                <a href='deletestaffrecord.php?delete={$staff_id}'>
                                <input class='btn btn-warning' type='submit' name='submit' value='Delete Profile'></a>
                            </div>
                                </td>
                              </tr> ";
                            }
                    ...
                    ?>
                        ...
                        <?php
                            ...
                            if(isset($_GET['delete'])){
                                ...
                                $query = "DELETE FROM staff WHERE staff_id = {$the_staff_id}";
                                $delete_query = mysqli_query($connection, $query);
                                header("Location: deletestaffrecord.php");
