            ...
            $.ajax({
                ...
                success: function (data) 
                {
                    ...
                    // general message
                        ...
                        this_form.find(".form-general-error-container").php(message_field_html).fadeIn("fast", function(){
                            // if submission was successful, hide message after some time
                            $(this).delay(10000).fadeOut("fast", function(){ $(this).php(""); });
                        });
                    }
                ...
                error: function (data) 
                {
                    ...
                    this_form.find(".form-general-error-container").php(error_field_html).fadeIn("fast");
